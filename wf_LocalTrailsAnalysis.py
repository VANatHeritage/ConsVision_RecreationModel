...
def main():
   ...
   expression = 'Status(!lTrl_bNeed!)'
   expression2 = 'Status(!lTrl_mNeed!)'
   ...
   arcpy.AddField_management (inHex, "lTrl_mStat", "SHORT")
   arcpy.CalculateField_management (inHex, "lTrl_mStat", expression2, "PYTHON", codeblock)
