...
def main():
   ...
   expression = 'Status(!rPrk_bNeed!)'
   expression2 = 'Status(!rPrk_mNeed!)'
   ...
   arcpy.AddField_management (inHex, "rPrk_mStat", "SHORT")
   arcpy.CalculateField_management (inHex, "rPrk_mStat", expression2, "PYTHON", codeblock)
