...
def main():
   ...
   expression = 'Status(!lPrk_bNeed!)'
   expression2 = 'Status(!lPrk_mNeed!)'
   ...
   arcpy.AddField_management (inHex, "lPrk_mStat", "SHORT")
   arcpy.CalculateField_management (inHex, "lPrk_mStat", expression2, "PYTHON", codeblock)
