...
def AssessRecOpps(inBenchVal, inPop, inPopSum, inRecPP, inPubAccess, outGDB, outBasename, inMask, inBenchMax = 5, remNulls = 0):
   ...
   - inMask = (optional) mask used to determine processing area. Best to use the final intended product boundary as mask for this (i.e., Virginia jurisdictional boundaries).
   ...
   RecScore = outGDB + os.sep + outBasename + "_RecScore"
   score.save(RecScore)
   ...
   RecNeed = outGDB + os.sep + outBasename + "_RecNeed"
   need.save(RecNeed)
