...
def main():
   ...
   expression = 'Status(!rSwm_bNeed!)'
   expression2 = 'Status(!rSwm_mNeed!)'
   ...
   arcpy.CalculateField_management (inHex, "rSwm_mStat", expression2, "PYTHON", codeblock)
