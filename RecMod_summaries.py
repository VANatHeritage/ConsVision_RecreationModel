...
inFolder = r"N:\ProProjects\RecAccessModel_2021\TIF_Albers"
inMask = r"N:\ProProjects\RecAccessModel_2021\Summaries.gdb\Mask"
inPop = r"N:\SpatialData\DCR\Population\p20\input_recmodel.gdb\distribPop_kdens_2019"

outFolder_png = r"N:\ProProjects\RecAccessModel_2021\PNG"
outFolder_xl = r"N:\ProProjects\RecAccessModel_2021\EXCEL"
outGDB = r"N:\ProProjects\RecAccessModel_2021\Summaries.gdb"
...
def stackbars(inTab, colorSet, titleType, outFolder_png, outFolder_xl, outName):
   ...
   if colorSet == "land":
      colors = ['#38A800', '#A9DC6D', '#EDF091', '#D2A957', '#734C00']
   else:
